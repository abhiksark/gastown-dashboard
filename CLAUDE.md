...
**YOU ARE IN: `gastown_dashboard/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/gastown_dashboard/` (rig root) or other directories
...
**Your mail address:** `gastown_dashboard/polecats/rust`
**Your rig:** gastown_dashboard
**Your Witness:** `gastown_dashboard/witness`
...
| Ask Witness for help | `gt mail send gastown_dashboard/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`gastown_dashboard/witness`) when:
...
```bash
gt mail send gastown_dashboard/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
